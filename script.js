...
const translations = {
  es: {
    ...
    "nav.products": "Clientes",
    "nav.brands": "Casos de cliente",
    "nav.launch": "Proceso",
    "nav.technology": "Tecnología",
    "nav.contact": "Contacto",
    "hero.eyebrow": "YC Systems LLC · Software operativo",
    "hero.title": "Software operativo para negocios que necesitan control y crecimiento",
    "hero.lede": "Construimos productos SaaS, sistemas internos, CRM, dashboards y automatización para convertir operaciones desordenadas en plataformas claras, medibles y listas para crecer.",
    "hero.cta.products": "Ver productos",
    "hero.cta.contact": "Solicitar diagnóstico",
    ...
    "showcase.copy": "YC Systems muestra conceptos completados e interfaces funcionales para que un cliente vea el valor antes de iniciar: dashboards, páginas web, formularios, roles, flujos y bases listas para presentar.",
    ...
    "status.broker": "Implementación operativa",
    ...
    "common.learn": "Ver más",
    "products.eyebrow": "Software operativo",
    "products.title": "Productos y sistemas creados para operaciones reales.",
    ...
    "broker.li3": "Implementación operativa con pantallas reales de dashboard",
    "broker.caption": "Dashboard BrokerControl: pipeline, documentos y control comercial.",
    "soc.pill": "Operaciones comerciales",
    ...
    "soc.li3": "Línea enfocada en visibilidad operativa",
    ...
    "clean.li2": "Preparado como ecosistema SaaS con múltiples roles",
    ...
    "launch.title": "Un proceso claro desde diagnóstico hasta mejora continua",
    "launch.copy": "YC Systems puede ayudar a ordenar la idea, diseñar la experiencia, construir la primera versión y preparar el proyecto para entrega o publicación.",
    "launch.domains.label": "01. Descubrir",
    "launch.domains.value": "Objetivos, usuarios y necesidades del negocio",
    "launch.domains.copy": "Definimos qué debe comunicar, vender, gestionar o automatizar el proyecto.",
    ...
    "launch.delivery.label": "03. Entregar",
    "launch.delivery.value": "Listo para presentar, publicar o mejorar",
    "launch.delivery.copy": "El resultado final queda preparado para revisión, lanzamiento, cambios futuros y uso del cliente.",
    ...
    "about.copy": "YC Systems desarrolla líneas internas, sistemas operativos por industria, dashboards, marcas digitales y soluciones para negocios reales.",
    ...
    "contact.copy": "Para páginas web, sistemas de negocio, dashboards, automatizaciones o consultas de proyecto, escribe por email o completa el diagnóstico.",
...
const textTranslations = {
  ...
  "Contacto": "Contact",
  "Desarrollamos productos SaaS, plataformas operativas y soluciones digitales que ayudan a empresas a crecer, vender mejor y operar con más control.": "We develop SaaS products, operational platforms and digital solutions that help companies grow, sell better and operate with more control.",
  ...
  "Ver líneas internas": "View product lines",
  "Ver proyectos de clientes": "View client cases",
  ...
  "Casos de cliente entregados para marcas, empresas y operaciones en crecimiento.": "Client cases delivered for brands, companies and growing operations.",
  ...
  "Cuál de estos proyectos se parece a lo que necesitas?": "Which of these projects looks like what you need?",
  ...
  "YC Systems desarrolla productos SaaS, plataformas operativas y soluciones digitales para empresas que necesitan vender mejor, operar con más control y escalar con tecnología.": "YC Systems develops SaaS products, operational platforms and digital solutions for companies that need to sell better, operate with more control and scale with technology.",
  "Construimos líneas internas y soluciones digitales para operaciones reales: CleanLoop, SOC, BrokerControl, sistemas internos, dashboards, marcas digitales y plataformas por industria.": "We build product lines and digital solutions for real operations: CleanLoop, SOC, BrokerControl, internal systems, dashboards, digital brands and industry platforms.",
  ...
  "La empresa combina líneas internas, casos de cliente y experiencia tecnica para crear soluciones que no se quedan en una pantalla bonita: deben ordenar operaciones, generar confianza comercial y abrir oportunidades de crecimiento.": "The company combines product lines, client cases and technical experience to create solutions that do not stop at a pretty screen: they must organize operations, build commercial trust and open growth opportunities.",
  ...
  "YC Systems LLC · Software operativo": "YC Systems LLC · Operating software",
  ...
  "Construimos productos SaaS, sistemas internos, CRM, dashboards y automatización para convertir operaciones desordenadas en plataformas claras, medibles y listas para crecer.": "We build SaaS products, internal systems, CRMs, dashboards and automation to turn messy operations into clear, measurable platforms ready to grow.",
  "Ver productos": "View products",
  ...
  "sitios y capturas reales": "real sites and screenshots",
  "Digital Brands": "Digital Brands",
  "Solicitar una solución": "Request a solution",
  "Qué puedes contratar": "What you can hire",
  ...
  "YC Systems se organiza alrededor de productos tecnológicos propios y casos reales que prueban la capacidad de crear, operar y escalar soluciones digitales.": "YC Systems is organized around owned technology products and real cases that prove the ability to create, operate and scale digital solutions.",
  ...
  "Producto SaaS por fases": "SaaS or phased product",
  ...
  "Producto SaaS o app por fases": "SaaS or app product",
  "Mantenimiento mensual": "Monthly maintenance",
  "Soluciones reales": "Real solutions",
  "6 soluciones reales construidas por YC Systems.": "6 real solutions built by YC Systems.",
  "Products, client cases and future platforms.": "Products, client cases and future platforms.",
  "YC Systems Ecosystem: productos, casos de cliente y plataformas en crecimiento.": "YC Systems Ecosystem: products, client cases and growing platforms.",
  "SOC, BrokerControl y CleanLoop lideran el ecosistema de productos. GhostWear y LucianoWash muestran casos reales de cliente. CreditPilot representa una futura plataforma financiera documentada.": "SOC, BrokerControl and CleanLoop lead the product ecosystem. GhostWear and LucianoWash show real client cases. CreditPilot represents a documented future financial platform.",
  "YC Systems separa líneas de producto, casos de cliente y capacidades en crecimiento para mostrar una empresa con activos tecnológicos, no solo servicios.": "YC Systems separates product lines, client cases and growing capabilities to show a company with technology assets, not just services.",
  ...
  "Cada caso demuestra una capacidad distinta: e-commerce, CRM, SaaS, operaciones, servicios locales y plataformas financieras.": "Each case demonstrates a different capability: e-commerce, CRM, SaaS, operations, local services and financial platforms.",
  ...
  "Web-app bilingüe para limpieza profesional con servicios, cotización por WhatsApp, reservas, chat y experiencia móvil.": "Bilingual web app for professional cleaning with services, WhatsApp quoting, bookings, chat and mobile experience.",
  "CreditPilot": "CreditPilot",
  "Línea documentada para gestión de clientes, casos, documentos, cartas, portal, compliance y roadmap técnico.": "Documented product line for clients, cases, documents, letters, portal, compliance and technical roadmap.",
  ...
  "Activos verificados": "Verified assets",
  ...
  "Casos de cliente": "Client cases",
  "Casos de cliente listos para vender y operar.": "Client cases ready to sell and operate.",
  ...
  "Canales actuales para proyectos: email, Instagram, Facebook, diagnóstico y portafolio de soluciones construidas por YC Systems.": "Current project channels: email, Instagram, Facebook, diagnostics and a portfolio of solutions built by YC Systems.",
  ...
  "Casos de cliente que muestran crecimiento.": "Client cases that show growth.",
...
Object.assign(textTranslations, {
  ...
  "Antes de hablar de una idea, puedes ver ejecución: proyectos publicados, líneas internas y una base técnica preparada para negocios reales.": "Before talking about an idea, you can see execution: published projects, product lines and a technical base prepared for real businesses.",
  "líneas internas": "product lines",
  ...
  "Base preparada para República Dominicana, Estados Unidos y Canadá.": "A base prepared for the Dominican Republic, the United States and Canada.",
  ...
  "YC Systems no es solo una página de servicios. Es una empresa tecnológica en construcción, con líneas internas, casos reales de cliente y una identidad nacida de trabajo, visión y familia.": "YC Systems is not just a services page. It is a technology company being built, with product lines, real client cases and an identity born from work, vision and family.",
  "La N tiene un significado especial: Nancy, origen emocional de esta visión y parte de la historia de la marca.": "The N has a special meaning: Nancy, the emotional origin of this vision and part of the brand story.",
  "Productos de software con mercados claros.": "Software products with clear markets.",
  ...
  "presentar marca inmobiliaria con más confianza.": "present a real estate brand with more trust.",
  ...
  "Los productos pertenecen al ecosistema YC Systems y respaldan la capacidad técnica mostrada en los casos de cliente.": "The products belong to the YC Systems ecosystem and support the technical capacity shown in client cases.",
  "Cuál de estos proyectos se parece a lo que necesitas?": "Which of these projects looks like what you need?",
...
Object.assign(textTranslations, {
  ...
  "Método claro para construir soluciones reales.": "A clear method for building real solutions.",
  ...
  "Dashboards, reportes, formularios, seguimiento, estados, alertas y procesos más fáciles de controlar.": "Dashboards, reports, forms, tracking, statuses, alerts and easier-to-control processes.",
  "Nexus como guia": "Nexus as a guide",
  "Analizamos, diseñamos, construimos y entregamos.": "We analyze, design, build and deliver.",
  ...
  "YC Systems puede vender una solución basada en estos productos, adaptar módulos a una industria, crear una nueva línea de producto o mantener una plataforma existente con mejoras mensuales.": "YC Systems can sell a solution based on these products, adapt modules to an industry, create a new product line or maintain an existing platform with monthly improvements.",
  ...
  "Ver proyectos de clientes": "View client cases",
  "Ver casos de cliente": "View client cases",
  ...
  "YC Systems no es solo una página de servicios. Es una empresa tecnológica en construcción, con líneas internas, casos reales de cliente y una identidad nacida de trabajo, visión y familia.": "YC Systems is not just a services page. It is a technology company being built, with product lines, real client cases and an identity born from work, vision and family.",
  "Los productos pertenecen al ecosistema YC Systems y respaldan la capacidad técnica mostrada en los casos de cliente.": "The products belong to the YC Systems ecosystem and support the technical capability shown in client cases.",
  ...
  "La meta es crear líneas internas, verticales por industria y casos de cliente que puedan crecer en República Dominicana, Estados Unidos y Canadá.": "The goal is to create product lines, industry verticals and client cases that can grow in the Dominican Republic, the United States and Canada.",
  "La meta es crear líneas internas, verticales por industria y casos de cliente que puedan crecer en República Dominicana, Estados Unidos y Canadá.": "The goal is to create product lines, industry verticals and client cases that can grow in the Dominican Republic, the United States and Canada.",
  "YC Systems muestra líneas de producto, casos de clientes, documentación operativa y un proceso claro para convertir nuevas ideas en activos digitales.": "YC Systems shows product lines, client cases, operational documentation and a clear process to turn new ideas into digital assets.",
  "YC Systems muestra líneas de producto, casos de clientes, documentación operativa y un proceso claro para convertir nuevas ideas en activos digitales.": "YC Systems shows product lines, client cases, operational documentation and a clear process to turn new ideas into digital assets.",
...
Object.assign(textTranslations, {
  ...
  "No empezamos vendiendo herramientas. Primero entendemos la operación, luego diseñamos el flujo correcto y construimos una solución que el negocio pueda usar.": "We do not start by selling tools. First we understand the operation, then we design the right flow and build a solution the business can use.",
  ...
  "Ordenamos pantallas, roles, acciones, datos y pasos para que la solución sea clara antes de desarrollar.": "We organize screens, roles, actions, data and steps so the solution is clear before development.",
  "Construccion": "Build",
  ...
  "CreditPilot queda como plataforma futura para credit repair, casos, documentos, cartas, portal de clientes y educación financiera.": "CreditPilot remains a future platform for credit repair, cases, documents, letters, customer portal and financial education.",
  ...
  "La marca se construye alrededor de líneas internas, casos reales y una forma de trabajar orientada a resultados. El objetivo no es solo entregar pantallas: es construir activos digitales que puedan mantenerse, venderse y evolucionar.": "The brand is built around product lines, real cases and a results-oriented way of working. The goal is not just to deliver screens: it is to build digital assets that can be maintained, sold and evolved.",
  "Enfoque": "Focus",
  "Líneas internas, casos de cliente, mantenimiento y soluciones para operaciones reales.": "Internal lines, client cases, maintenance and solutions for real operations.",
  "Líneas internas, casos de cliente, mantenimiento y soluciones para operaciones reales.": "Internal lines, client cases, maintenance and solutions for real operations.",
  "Valores": "Values",
  ...
  "Producto SaaS por fases": "Phased SaaS product",
  ...
  "Definir producto": "Define product",
  ...
  "Empresa digital de software constituida en New York. Construimos webs, sistemas internos, CRM, dashboards, automatizaciones y plataformas SaaS para negocios reales.": "Digital software company formed in New York. We build websites, internal systems, CRM, dashboards, automations and SaaS platforms for real businesses.",
  ...
  "Algunas líneas internas de YC Systems están disponibles por invitación, piloto o acceso controlado para proteger propiedad intelectual y procesos en desarrollo.": "Some YC Systems product lines are available by invitation, pilot or controlled access to protect intellectual property and processes in development."
});
...
const englishTextTranslations = {
  ...
  "Privacy": "Privacidad",
  "Terms": "Términos",
  "YC Systems is not just a services page. It is a technology company being built, with product lines, real client cases and an identity born from work, vision and family.": "YC Systems no es solo una página de servicios. Es una empresa tecnológica en construcción, con líneas internas, casos reales de cliente y una identidad nacida de trabajo, visión y familia.",
  "The N has a special meaning: Nancy, the emotional origin of this vision and part of the brand story.": "La N tiene un significado especial: Nancy, origen emocional de esta visión y parte de la historia de la marca.",
  ...
  "A clear method for building real solutions.": "Método claro para construir soluciones reales.",
  ...
  "Dashboards, reports, forms, tracking, statuses, alerts and easier-to-control processes.": "Dashboards, reportes, formularios, seguimiento, estados, alertas y procesos más fáciles de controlar.",
  "Nexus as a guide": "Nexus como guia",
  "We analyze, design, build and deliver.": "Analizamos, diseñamos, construimos y entregamos.",
  ...
  "View client cases": "Ver casos de cliente",
  ...
  "The products belong to the YC Systems ecosystem and support the technical capability shown in client cases.": "Los productos pertenecen al ecosistema YC Systems y respaldan la capacidad técnica mostrada en los casos de cliente.",
...
Object.assign(textTranslations, {
  ...
  "Construimos productos de software que ayudan a las empresas a operar, crecer y escalar.": "We build software products that help companies operate, grow and scale.",
  "Desarrollamos productos SaaS, plataformas operativas y soluciones digitales que ayudan a empresas a crecer, vender mejor y operar con más control.": "We develop SaaS products, operational platforms and digital solutions that help businesses grow, sell better and operate with more control.",
  ...
  "Nexus recomienda CleanLoop cuando la lavandería necesita separar cliente, driver, admin y rutas.": "Nexus recommends CleanLoop when the laundry needs to separate customer, driver, admin and routes.",
...
Object.assign(englishTextTranslations, {
  ...
  "Nexus recommends CleanLoop when the laundry needs to separate customer, driver, admin and routes.": "Nexus recomienda CleanLoop cuando la lavandería necesita separar cliente, driver, admin y rutas.",
...
Object.assign(textTranslations, {
  ...
  "YC Systems no se presenta solo como una agencia de páginas web. La empresa construye activos digitales: líneas internas, sistemas por industria, e-commerce, dashboards, automatizaciones y casos de cliente que pueden mantenerse y evolucionar.": "YC Systems is not presented only as a website agency. The company builds digital assets: product lines, industry systems, e-commerce, dashboards, automations and client cases that can be maintained and evolved.",
...
Object.assign(englishTextTranslations, {
  ...
  "YC Systems is not presented only as a website agency. The company builds digital assets: product lines, industry systems, e-commerce, dashboards, automations and client cases that can be maintained and evolved.": "YC Systems no se presenta solo como una agencia de páginas web. La empresa construye activos digitales: líneas internas, sistemas por industria, e-commerce, dashboards, automatizaciones y casos de cliente que pueden mantenerse y evolucionar.",
...
Object.assign(englishTextTranslations, {
  ...
  "This website may use form, hosting, domain/DNS, email and analytics services when connected for business communication.": "Este sitio web puede usar servicios de formularios, hosting, dominio/DNS, correo y analítica cuando están conectados para operar la comunicación comercial.",
...
const pageMetadataTranslations = {
  es: {
    "/": {
      ...
      description: "YC Systems LLC construye software operativo, productos SaaS, sistemas internos, CRM, dashboards y automatización para negocios que necesitan control y crecimiento.",
    },
    "/privacy/": {
  ...
  en: {
    "/": {
      title: "YC Systems LLC — Operating software for real businesses",
      description: "YC Systems LLC builds operating software, SaaS products, internal systems, CRM, dashboards and automation for businesses that need control and growth.",
    },
    "/privacy/": {
...
Object.assign(textTranslations, {
  ...
  "Portal de desarrolladores": "Developer Platform",
  "Solicitar diagnóstico": "Request assessment",
  "Ver casos de clientes": "View client cases",
...
Object.assign(englishTextTranslations, {
  ...
  "Developer Platform": "Portal de desarrolladores",
  "Request assessment": "Solicitar diagnóstico",
  "View client cases": "Ver casos de clientes",
...
Object.assign(textTranslations, {
  ...
  "Bases SaaS por fases para líneas internas o verticales nuevos.": "Phased SaaS foundations for product lines or new verticals.",
  ...
  "Sitios rápidos, publicaciones controladas y rutas listas para monitoreo futuro.": "Fast sites, controlled releases and routes ready for future monitoring.",
...
Object.assign(textTranslations, {
  ...
  "Una base organizada para productos, clientes y operación.": "An organized base for products, clients and operations.",
  ...
  "Implementación operativa": "Operational implementation",
  "Audiencia": "Audience",
  "Beneficio": "Benefit",
  "Funciones": "Features",
...
Object.assign(textTranslations, {
  ...
  "CRM y flujos comerciales para controlar prospectos, próximas acciones, documentos y cierres.": "CRM and commercial flows to control prospects, next actions, documents and closings.",
  ...
  "La empresa mantiene líneas internas en lavandería, operaciones comerciales, CRM, finanzas y automatización. Algunas se usan como laboratorio de producto y arquitectura con comunicación controlada según su etapa de mercado.": "The company maintains product lines in laundry, commercial operations, CRM, finance and automation. Some are used as product and architecture labs with controlled communication according to their market stage.",
  "Siguiente paso": "Next step",
  ...
  "Casos de cliente con sitios activos y resultados visibles.": "Client cases with active sites and visible results.",
  "No mostramos promesas vacías. Mostramos proyectos publicados, dominios activos y soluciones que ya pueden ser visitadas por clientes reales.": "We do not show empty promises. We show published projects, active domains and solutions that can already be visited by real customers.",
  ...
  "Somos una empresa tecnológica constituida en New York, enfocada en construir soluciones digitales, sistemas internos, plataformas operativas y software por fases para negocios reales.": "We are a technology company formed in New York, focused on building digital solutions, internal systems, operational platforms and phased software for real businesses.",
  ...
  "YC Systems LLC es una compañía de responsabilidad limitada constituida en New York. La web comparte solo la información necesaria para confianza comercial y mantiene los datos sensibles fuera del sitio público.": "YC Systems LLC is a limited liability company formed in New York. The website shares only the information needed for commercial trust and keeps sensitive data out of the public site.",
});
...
Object.assign(textTranslations, {
  ...
  "Ver casos de cliente": "See Client Cases",
  ...
  "Empresa de producto + casos de cliente": "Product company + client cases",
  "Construcción por fases": "Built in phases",
  "Implementaciones controladas de producto": "Controlled product implementations",
  ...
  "YC Systems no es solo una lista de servicios. La compañía construye productos, sistemas y plataformas que nacen de operaciones reales, implementaciones controladas y aprendizaje con clientes.": "YC Systems is not just a list of services. The company builds products, systems and platforms born from real operations, controlled access and client learning.",
  "Algunos productos de YC Systems están disponibles solo mediante acceso controlado, acceso temprano o implementación seleccionada con clientes.": "Some YC Systems products are available only through controlled access, early access or selected client implementation.",
  ...
  "Acceso controlado / implementación temprana": "Controlled access / early implementation",
  ...
  "Disponible para operadores seleccionados y socios de implementación temprana.": "Available for selected operators and early implementation partners.",
  ...
  "Línea de producto seleccionada": "Selected product line",
  ...
  "Producto de operaciones financieras en evaluación.": "Financial operations product under evaluation.",
  ...
  "Para empresas que necesitan software a medida, sistemas internos, dashboards, automatización o productos SaaS sin convertir la improvisación en deuda técnica.": "For companies that need custom software, internal systems, dashboards, automation or productos SaaS without turning improvisation into technical debt.",
  ...
  "Producto SaaS + soporte": "SaaS Products + Support",
  ...
  "Proyectos de clientes que prueban ejecución.": "Client cases that proves execution.",
  ...
  "Empresa digital de software que construye productos, sistemas y plataformas para operaciones reales.": "Digital software company building products, systems and platforms for real business operations.",
  "Centro de confianza": "Trust Center",
});
...
Object.assign(englishTextTranslations, {
  ...
  "See Client Cases": "Ver casos de cliente",
  ...
  "Product company + client cases": "Empresa de producto + casos de cliente",
  "Built in phases": "Construcción por fases",
  "Controlled product implementations": "Implementaciones controladas de producto",
  ...
  "Some YC Systems products are available only through controlled access, early access or selected client implementation.": "Algunos productos de YC Systems están disponibles solo mediante acceso controlado, acceso temprano o implementación seleccionada con clientes.",
  ...
  "Selected product line": "Línea de producto seleccionada",
  ...
  "Dashboards": "Dashboards",
  "Automation": "Automatización",
  "SaaS Products + Support": "Producto SaaS + soporte",
  "Maintenance & Support": "Mantenimiento y soporte",
  "AI Integrations": "Integraciones IA",
  "Client cases that prove execution.": "Casos de cliente que prueban ejecución.",
  "Nexus Method": "Método Nexus",
  "Nexus is how YC Systems thinks.": "Nexus es la forma en que YC Systems piensa.",
  "Digital software company building products, systems and platforms for real business operations.": "Empresa digital de software que construye productos, sistemas y plataformas para operaciones reales.",
  "Products": "Productos",
  "Trust Center": "Centro de confianza",
});
...
Object.assign(textTranslations, {
  ...
  "Productos propios, casos de cliente, procesos reales y activos publicados verificables.": "Owned products, client cases, real processes and verifiable published assets.",
});
...
Object.assign(englishTextTranslations, {
  ...
  "Owned products, client cases, real processes and verifiable published assets.": "Productos propios, casos de cliente, procesos reales y activos publicados verificables.",
});
...
Object.assign(textTranslations, {
  ...
  "Presencia comercial": "Commercial presence",
  "Sitios y landings para empresas que necesitan explicar, vender y generar confianza desde el primer contacto.": "Websites and landing pages for companies that need to explain, sell and build trust from the first contact.",
  "Mensaje comercial": "Commercial message",
  "Contacto claro": "Clear contact",
  "CRM operativo": "Operating CRM",
  "Seguimiento comercial para prospectos, clientes, tareas, cotizaciones, documentos y cierres.": "Commercial tracking for prospects, customers, tasks, quotes, documents and closings.",
  "Diseñar CRM": "Design CRM",
  "Dashboards ejecutivos": "Executive dashboards",
  "Indicadores, reportes y vistas ejecutivas para tomar decisiones con datos visibles.": "Indicators, reports and executive views to make decisions with visible data.",
  "Flujos, alertas, integraciones y reglas para reducir trabajo repetitivo y errores manuales.": "Workflows, alerts, integrations and rules to reduce repetitive work and manual errors.",
  "Producto SaaS": "Producto SaaS",
...
Object.assign(englishTextTranslations, {
  ...
  "YC Systems LLC · Operating software": "YC Systems LLC · Software operativo",
  ...
  "Websites and landing pages for companies that need to explain, sell and build trust from the first contact.": "Sitios y landings para empresas que necesitan explicar, vender y generar confianza desde el primer contacto.",
  "Commercial message": "Mensaje comercial",
  "Clear contact": "Contacto claro",
  "Operating CRM": "CRM operativo",
  "Commercial tracking for prospects, customers, tasks, quotes, documents and closings.": "Seguimiento comercial para prospectos, clientes, tareas, cotizaciones, documentos y cierres.",
  "Design CRM": "Diseñar CRM",
  "Executive dashboards": "Dashboards ejecutivos",
  "Indicators, reports and executive views to make decisions with visible data.": "Indicadores, reportes y vistas ejecutivas para tomar decisiones con datos visibles.",
  "Workflows, alerts, integrations and rules to reduce repetitive work and manual errors.": "Flujos, alertas, integraciones y reglas para reducir trabajo repetitivo y errores manuales.",
  "Producto SaaS": "Producto SaaS",
...
Object.assign(textTranslations, {
  "Empresa digital de software que construye productos, sistemas y plataformas para operaciones reales.": "Digital software company building products, systems and platforms for real business operations.",
  "Operación digital global": "Global digital operation",
  "Atención digital global": "Global digital service",
  "Evolución controlada": "Controlled evolution",
  "Cada línea se comunica con el nivel de detalle correcto mientras avanza hacia mercado, implementación seleccionada y soporte real.": "Each product line is communicated with the right level of detail as it moves toward market, selected implementation and real support.",
  "Producto de operaciones financieras con evolución controlada.": "Financial operations product with controlled evolution.",
  "En evaluación": "Under evaluation",
  "Cada línea se presenta con una comunicación responsable según su etapa de mercado.": "Each line is presented with responsible communication according to its market stage."
});

Object.assign(englishTextTranslations, {
  "Digital software company building products, systems and platforms for real business operations.": "Empresa digital de software que construye productos, sistemas y plataformas para operaciones reales.",
  "Global digital operation": "Operación digital global",
  "Global digital service": "Atención digital global",
  "Controlled evolution": "Evolución controlada",
  "Each product line is communicated with the right level of detail as it moves toward market, selected implementation and real support.": "Cada línea se comunica con el nivel de detalle correcto mientras avanza hacia mercado, implementación seleccionada y soporte real.",
  "Financial operations product with controlled evolution.": "Producto de operaciones financieras con evolución controlada.",
  "Under evaluation": "En evaluación",
  "Each line is presented with responsible communication according to its market stage.": "Cada línea se presenta con una comunicación responsable según su etapa de mercado."
});
