...
const textTranslations = {
  ...
  "Construimos líneas internas y soluciónes digitales para operaciones reales: CleanLoop, SOC, BrokerControl, sistemas internos, dashboards, marcas digitales y plataformas por industria.": "We build product lines and digital solutions for real operations: CleanLoop, SOC, BrokerControl, internal systems, dashboards, digital brands and industry platforms.",
  ...
  "La empresa combina líneas internas, casos de cliente y experiencia tecnica para crear soluciónes que no se quedan en una pantalla bonita: deben ordenar operaciones, generar confianza comercial y abrir oportunidades de crecimiento.": "The company combines product lines, client cases and technical experience to create solutions that do not stop at a pretty screen: they must organize operations, build commercial trust and open growth opportunities.",
  ...
  "YC Systems separa líneas internas, casos de cliente y prototipos en crecimiento para mostrar una empresa con activos tecnologicos, no solo servicios.": "YC Systems separates product lines, client projects and growing prototypes to show a company with technology assets, not just services.",
