...
const translations = {
  es: {
    ...
    "identity.label": "Estudio portafolio",
    "identity.copy": "Paginas web, dashboards, sistemas de negocio, automatizaciones, soluciones en la nube y marcas digitales.",
    ...
    "identity.model.label": "Firma",
    "identity.model.value": "Desarrollado por YC Systems",
    ...
    "status.ghost": "Marca e-commerce activa",
    "card.ghost.copy": "Una marca de streetwear para atletas y personas que conectan con ropa premium, cultura de drops y ambicion silenciosa.",
    ...
    "brands.eyebrow": "Marcas digitales",
    "brands.copy": "GhostWear es la marca de lifestyle y ropa dentro del ecosistema YC Systems: streetwear, drops, identidad visual y e-commerce construido como una marca real.",
...
const animatedElements = document.querySelectorAll(
  ".section-head, .product-card, .product-detail, .brand-story, .apparel-showcase, .about-grid, .stack-grid, .contact-panel"
);
