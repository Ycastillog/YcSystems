...
const translations = {
  es: {
    ...
    "ownership.one.copy": "Cada página o sistema se enfoca en lo que el negocio necesita vender, gestiónar o automatizar.",
    ...
    "launch.domains.copy": "Definimos que debe comunicar, vender, gestiónar o automatizar el proyecto.",
...
const textTranslations = {
  ...
  "YC Systems separa líneas de producto, casos de cliente y capacidades en crecimiento para mostrar una empresa con activos tecnológicos, no solo servicios.": "YC Systems separates product lines, client projects and growing capabilities to show a company with technology assets, not just services.",
...
Object.assign(textTranslations, {
  ...
  "La meta es crear líneas internas, verticales por industria y client projects que puedan crecer en Dominican Republic, United States y Canadá.": "The goal is to create product lines, industry verticals and client projects that can grow in the Dominican Republic, the United States and Canada.",
  "La meta es crear líneas internas, verticales por industria y proyectos de clientes que puedan crecer en República Dominicana, Estados Unidos y Canadá.": "The goal is to create product lines, industry verticals and client projects that can grow in the Dominican Republic, the United States and Canada.",
...
Object.assign(textTranslations, {
  ...
  "Enfoque": "Focus",
  "Líneas internas, client projects, mantenimiento y soluciones para operaciones reales.": "Internal lines, client projects, maintenance and solutions for real operations.",
  "Líneas internas, proyectos de clientes, mantenimiento y soluciones para operaciones reales.": "Internal lines, client projects, maintenance and solutions for real operations.",
  "Valores": "Values",
...
Object.assign(textTranslations, {
  ...
  "YC Systems no se presenta solo como una agencia de páginas web. La empresa construye activos digitales: líneas internas, sistemas por industria, e-commerce, dashboards, automatizaciones y proyectos de cliente que pueden mantenerse y evolucionar.": "YC Systems is not presented only as a website agency. The company builds digital assets: product lines, industry systems, e-commerce, dashboards, automations and client projects that can be maintained and evolved.",
...
Object.assign(englishTextTranslations, {
  ...
  "YC Systems is not presented only as a website agency. The company builds digital assets: product lines, industry systems, e-commerce, dashboards, automations and client projects that can be maintained and evolved.": "YC Systems no se presenta solo como una agencia de páginas web. La empresa construye activos digitales: líneas internas, sistemas por industria, e-commerce, dashboards, automatizaciones y proyectos de cliente que pueden mantenerse y evolucionar.",
...
Object.assign(textTranslations, {
  ...
  "Vertical para gestiónar casos, cartas, documentos y portal de clientes.": "Vertical system to manage cases, letters, documents and client portals.",
...
Object.assign(textTranslations, {
  ...
  "La empresa mantiene líneas internas en lavandería, operaciones comerciales, CRM, finanzas y automatización. Algunas se usan como laboratorio de producto y arquitectura, sin exponerse públicamente como soluciones finales hasta estar listas estratégica y legalmente.": "The company maintains product lines in laundry, commercial operations, CRM, finance and automation. Some are used as product and architecture labs with controlled communication until each product is strategically and legally ready.",
  "Siguiente paso": "Next step",
...
Object.assign(textTranslations, {
  ...
  "CleanLoop ayuda a operadores de lavandería a gestiónar órdenes, clientes, recogidas, entregas y flujos de trabajo desde un solo sistema.": "CleanLoop helps laundry operators manage orders, customers, pickups, deliveries and workflows from one system.",
...
Object.assign(englishTextTranslations, {
  ...
  "Client cases that proves execution.": "Proyectos de clientes que prueban ejecución.",
