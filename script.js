...
const translations = {
  es: {
    ...
    "identity.copy": "Tiendas activas, dashboards de negocio, sistemas operativos y experiencias web desarrolladas bajo YC Systems.",
    ...
    "identity.model.label": "Marca activa",
