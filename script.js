...
const textTranslations = {
  ...
  "YC Systems desarrolla productos SaaS, plataformas operativas y soluciones digitales para empresas que necesitan vender mejor, operar con mas control y escalar con tecnologia.": "YC Systems develops SaaS products, operational platforms and digital solutions for companies that need to sell better, operate with more control and scale with technology.",
  ...
  "Convertir procesos complejos en productos digitales claros, utiles y escalables.": "Turn complex processes into clear, useful and scalable digital products.",
  ...
  "Productos primero. Servicios como capacidad de construccion.": "Products first. Services as a build capability.",
  ...
  "YC Systems combina producto, tecnologia y ejecucion comercial.": "YC Systems combines product, technology and commercial execution.",
  ...
  "Canales actuales para proyectos: email, Instagram, Facebook, GitHub publico y portafolio de soluciones construidas por YC Systems.": "Current project channels: email, Instagram, Facebook, public GitHub and a portfolio of solutions built by YC Systems.",
...
Object.assign(textTranslations, {
  ...
  "Nexus representa nuestra forma de construir: analizar, disenar, automatizar y entregar productos digitales que ayudan a empresas reales a operar mejor.": "Nexus represents how we build: analyze, design, automate and deliver digital products that help real companies operate better.",
  "Analizar": "Analyze",
  "Disenar": "Design",
  "Construir": "Build",
  "Entregar": "Deliver",
  ...
  "La marca combina azul electrico, azul profundo, blanco, gris y acentos de accion para verse tecnologica, seria y reconocible. Nexus ayuda a explicar el proceso; los productos y sitios reales prueban la ejecucion.": "The brand combines electric blue, deep blue, white, gray and action accents to feel technological, serious and recognizable. Nexus explains the process; the products and live websites prove execution.",
  "YC Systems no es solo una pagina de servicios. Es una empresa tecnologica en construccion, con productos propios, client projects reales y una identidad nacida de trabajo, vision y familia.": "YC Systems is not just a services page. It is a technology company being built, with owned products, real client projects and an identity born from work, vision and family.",
  "La N tiene un significado especial: Nancy, origen emocional de esta vision y parte de la historia de la marca.": "The N has a special meaning: Nancy, the emotional origin of this vision and part of the brand story.",
  "Productos de software con mercados claros.": "Software products with clear markets.",
  "Cada producto resuelve una operacion distinta y abre una oportunidad comercial diferente.": "Each product solves a different operation and opens a different commercial opportunity.",
  "Pilot & Partnerships": "Pilot & Partnerships",
  "Product Ready": "Product Ready",
  "Coming Soon": "Coming Soon",
  "Laundry Operations Platform para lavanderias, drivers, clientes, tracking, pagos y flujo SaaS.": "Laundry Operations Platform for laundries, drivers, customers, tracking, payments and SaaS workflow.",
  "Laundry Operations Platform para lavanderias que necesitan pedidos, drivers, clientes, tracking, pagos y operacion diaria en un solo sistema.": "Laundry Operations Platform for laundries that need orders, drivers, customers, tracking, payments and daily operations in one system.",
  ...
  "Tienda streetwear con catalogo, productos, carrito y pedido por WhatsApp.": "Streetwear store with catalog, products, cart and WhatsApp ordering.",
  ...
  "Web de servicios de limpieza con imagen profesional, WhatsApp y experiencia movil.": "Cleaning services website with professional image, WhatsApp and mobile experience.",
  ...
  "Sobre YC Systems": "About YC Systems",
  "Mision, vision y valores construidos alrededor de productos de software.": "Mission, vision and values built around software products.",
  "YC Systems convierte problemas operativos en productos digitales claros, utiles y escalables.": "YC Systems turns operational problems into clear, useful and scalable digital products.",
  ...
  "Menos complejidad. Mas claridad.": "Less complexity. More clarity.",
  "Tecnologia aplicada a problemas reales.": "Technology applied to real problems.",
  "Actuamos como duenos.": "We act like owners.",
  "El software debe generar impacto.": "Software must create impact.",
  "Hablemos de tu proxima pagina, aplicacion, sistema o plataforma.": "Let's talk about your next website, application, system or platform.",
  "Canales actuales para proyectos: email, Instagram, Facebook, GitHub publico y portafolio de soluciones construidas por YC Systems.": "Current channels for projects: email, Instagram, Facebook, public GitHub and a portfolio of solutions built by YC Systems.",
  "Email principal: yeicastillog@gmail.com": "Primary email: yeicastillog@gmail.com",
  "Email alterno: yeicastillog@hotmail.com": "Alternate email: yeicastillog@hotmail.com",
  "Instagram oficial: @yc.systems": "Official Instagram: @yc.systems",
  "Facebook oficial: YC Systems": "Official Facebook: YC Systems",
  "GitHub publico: Ycastillog": "Public GitHub: Ycastillog",
  ...
  "e-commerce, catalogo, carrito y pedido por WhatsApp.": "e-commerce, catalog, cart and WhatsApp ordering.",
  ...
  "identidad, base digital y presentacion comercial.": "identity, digital base and commercial presentation.",
...
Object.assign(textTranslations, {
  "4 productos. 5 sitios activos. 1 empresa tecnologica.": "4 Products. 5 Live Websites. 1 Technology Company.",
  "4 productos": "4 Products",
  "5 sitios activos": "5 Live Websites",
  "Dominios de clientes": "Client Domains",
  "Republica Dominicana - Estados Unidos - Canada": "Dominican Republic - United States - Canada",
  ...
  "YC Systems no es solo una pagina de servicios. Es una empresa tecnologica en construccion, con productos propios, proyectos de clientes reales y una identidad nacida de trabajo, vision y familia.": "YC Systems is not just a services page. It is a technology company being built, with owned products, real client projects and an identity born from work, vision and family.",
  "YC Systems / Tecnologia": "YC Systems / Technology",
  "Stack para negocio": "Business stack",
  "Tecnologia para soluciones reales.": "Technology for real solutions.",
  "Con esta base construimos tiendas, sistemas internos, dashboards, SaaS, apps moviles, pagos, integraciones y automatizaciones.": "With this foundation we build stores, internal systems, dashboards, SaaS, mobile apps, payments, integrations and automations.",
  "Quiero construir algo": "I want to build something",
  "Ver proyectos": "View projects",
  "Soluciones por tecnologia": "Solutions by technology",
  "La tecnologia se presenta como capacidad de negocio.": "Technology is presented as business capability.",
  ...
  "Paginas, tiendas y catalogos listos para publicar.": "Websites, stores and catalogs ready to publish.",
  "Landing pages, sitios corporativos, catalogos visuales, carrito, productos y pedidos por WhatsApp.": "Landing pages, corporate sites, visual catalogs, cart, products and WhatsApp ordering.",
  "Sistemas internos": "Internal systems",
  ...
  "Experiencias moviles conectadas al negocio.": "Mobile experiences connected to the business.",
  ...
  "Conexiones que convierten un sistema en operacion real.": "Connections that turn a system into a real operation.",
  ...
  "Nexus ayuda a presentar la tecnologia como un proceso claro: entender la operacion, disenar el flujo, construir el producto y entregar una solucion lista para mejorar.": "Nexus helps present technology as a clear process: understand the operation, design the flow, build the product and deliver a solution ready to improve.",
  ...
  "CleanLoop, BrokerControl y SOC muestran backend, bases de datos, roles, dashboards e integraciones. GhostWear muestra e-commerce, catalogo, carrito y venta por WhatsApp.": "CleanLoop, BrokerControl and SOC show backend, databases, roles, dashboards and integrations. GhostWear shows e-commerce, catalog, cart and WhatsApp sales.",
  ...
  "Quiero orientacion": "I want guidance",
  "Es suficiente enviar la idea en lenguaje simple. YC Systems la convierte en alcance, pantallas, tecnologia y proximos pasos.": "It is enough to send the idea in simple language. YC Systems turns it into scope, screens, technology and next steps.",
  "Pagina profesional": "Professional website",
  "Marca, servicios, contacto, portafolio, SEO basico y version movil.": "Brand, services, contact, portfolio, basic SEO and mobile version.",
  "Productos, carrito, pedidos, WhatsApp, dominio propio y presentacion visual.": "Products, cart, orders, WhatsApp, own domain and visual presentation.",
  ...
  "Versiones en espanol e ingles para presentar tu negocio a mas clientes.": "Spanish and English versions to present your business to more customers.",
  "Explica el problema, el tipo de negocio y el resultado que quieres. YC Systems convierte esa idea en una ruta inicial de producto, tecnologia y entrega.": "Explain the problem, business type and result you want. YC Systems turns that idea into an initial product, technology and delivery path.",
  "Ver proyectos de clientes": "View client projects",
  ...
  "Una vision clara: construir productos de software y soluciones digitales con ejecucion real.": "A clear vision: build software products and digital solutions with real execution.",
  ...
  "La meta es crear productos propios, verticales por industria y proyectos de clientes que puedan crecer en Republica Dominicana, Estados Unidos y Canada.": "The goal is to create owned products, industry verticals and client projects that can grow in the Dominican Republic, the United States and Canada.",
  "YC Systems ya muestra productos propios, client projects, repositorios publicos y privados, documentacion tecnica y un proceso claro para convertir nuevas ideas en activos digitales.": "YC Systems already shows owned products, client projects, public and private repositories, technical documentation and a clear process to turn new ideas into digital assets.",
  "YC Systems ya muestra productos propios, proyectos de clientes, repositorios publicos y privados, documentacion tecnica y un proceso claro para convertir nuevas ideas en activos digitales.": "YC Systems already shows owned products, client projects, public and private repositories, technical documentation and a clear process to turn new ideas into digital assets.",
  "Productos funcionales": "Functional products"
});

Object.assign(textTranslations, {
  "Soluciones por nivel": "Solutions by level",
  "Empieza pequeno, pero con una base lista para crecer.": "Start small, but with a base ready to grow.",
  "Una pagina web, una tienda o un portal no se cotizan igual. YC Systems organiza cada proyecto por fases para que el cliente compre claridad, no improvisacion.": "A website, store, or portal is not quoted the same way. YC Systems organizes each project by phases so the client buys clarity, not improvisation.",
  ...
  "Movil y SEO basico": "Mobile and basic SEO",
  "Tienda / catalogo": "Store / catalog",
  "Productos listos para vender mejor": "Products ready to sell better",
  "Para marcas que necesitan catalogo visual, carrito, pedidos por WhatsApp o flujo e-commerce.": "For brands that need a visual catalog, cart, WhatsApp orders, or an e-commerce flow.",
  "Productos y categorias": "Products and categories",
  "Pedido simple": "Simple ordering",
  "Experiencia movil": "Mobile experience",
  "Sistema interno": "Internal system",
  ...
  "Perfecto para empresas que quieren acceso privado, seguimiento, documentos y procesos por modulo.": "Perfect for companies that want private access, tracking, documents, and module-based processes.",
  ...
  "Los sitios profesionales se trabajan por alcance. Los sistemas, portales y SaaS se cotizan por modulos, fases y nivel de automatizacion.": "Professional sites are scoped by deliverables. Systems, portals, and SaaS are quoted by modules, phases, and automation level.",
  "Solicitar orientacion": "Request guidance",
  "Asesor inmobiliario": "Real estate advisor",
  "Web profesional para asesorar compradores que quieren adquirir propiedad en Republica Dominicana.": "Professional website to advise buyers who want to acquire property in the Dominican Republic.",
  ...
  "Tienda online o catalogo": "Online store or catalog",
...
Object.assign(textTranslations, {
  ...
  "No es solo codigo. Es una operacion mas clara.": "It is not just code. It is a clearer operation.",
  "YC Systems usa tecnologia moderna, pero la presenta como valor de negocio: vender mejor, medir mejor, responder mas rapido y trabajar con menos caos.": "YC Systems uses modern technology, but presents it as business value: sell better, measure better, respond faster and work with less chaos.",
  ...
  "Empresa tecnologica": "Technology company",
  ...
  "YC Systems nace de construir, probar y mejorar soluciones con problemas reales delante: ventas, reservas, clientes, rutas, dashboards, e-commerce y automatizacion.": "YC Systems was born from building, testing and improving solutions around real problems: sales, reservations, clients, routes, dashboards, e-commerce and automation.",
  "Identidad visual": "Visual identity",
  "Nexus es el constructor digital de YC Systems.": "Nexus is the digital builder of YC Systems.",
  "Nexus representa nuestra forma de explicar tecnologia sin complicarla: analizar, disenar, automatizar y entregar soluciones digitales que ayudan a las empresas a operar mejor.": "Nexus represents our way of explaining technology without complicating it: analyze, design, automate and deliver digital solutions that help companies operate better."
});
...
const englishTextTranslations = {
  ...
  "4 Products. 5 Live Websites. 1 Technology Company.": "4 productos. 5 sitios activos. 1 empresa tecnologica.",
  "4 Products": "4 productos",
  "5 Live Websites": "5 sitios activos",
  "Client Domains": "Dominios de clientes",
  "Dominican Republic - United States - Canada": "Republica Dominicana - Estados Unidos - Canada",
  ...
  "Privacy": "Privacidad",
  "Terms": "Terminos",
  "YC Systems is not just a services page. It is a technology company being built, with owned products, real client projects and an identity born from work, vision and family.": "YC Systems no es solo una pagina de servicios. Es una empresa tecnologica en construccion, con productos propios, proyectos de clientes reales y una identidad nacida de trabajo, vision y familia.",
  "The N has a special meaning: Nancy, the emotional origin of this vision and part of the brand story.": "La N tiene un significado especial: Nancy, origen emocional de esta vision y parte de la historia de la marca.",
  "YC Systems / Technology": "YC Systems / Tecnologia",
  "Business stack": "Stack para negocio",
  "Technology for real solutions.": "Tecnologia para soluciones reales.",
  "With this foundation we build stores, internal systems, dashboards, SaaS, mobile apps, payments, integrations and automations.": "Con esta base construimos tiendas, sistemas internos, dashboards, SaaS, apps moviles, pagos, integraciones y automatizaciones.",
  "I want to build something": "Quiero construir algo",
  "View projects": "Ver proyectos",
  "Solutions by technology": "Soluciones por tecnologia",
  "Technology is presented as business capability.": "La tecnologia se presenta como capacidad de negocio.",
  ...
  "Websites, stores and catalogs ready to publish.": "Paginas, tiendas y catalogos listos para publicar.",
  "Landing pages, corporate sites, visual catalogs, cart, products and WhatsApp ordering.": "Landing pages, sitios corporativos, catalogos visuales, carrito, productos y pedidos por WhatsApp.",
  ...
  "Mobile experiences connected to the business.": "Experiencias moviles conectadas al negocio.",
  ...
  "Connections that turn a system into a real operation.": "Conexiones que convierten un sistema en operacion real.",
  ...
  "Nexus helps present technology as a clear process: understand the operation, design the flow, build the product and deliver a solution ready to improve.": "Nexus ayuda a presentar la tecnologia como un proceso claro: entender la operacion, disenar el flujo, construir el producto y entregar una solucion lista para mejorar.",
  ...
  "CleanLoop, BrokerControl and SOC show backend, databases, roles, dashboards and integrations. GhostWear shows e-commerce, catalog, cart and WhatsApp sales.": "CleanLoop, BrokerControl y SOC muestran backend, bases de datos, roles, dashboards e integraciones. GhostWear muestra e-commerce, catalogo, carrito y venta por WhatsApp.",
  ...
  "I want guidance": "Quiero orientacion",
  "Professional website": "Pagina profesional",
  ...
  "Technology company": "Empresa tecnologica",
  "Founder-led technology company": "Empresa tecnologica liderada por su fundador",
...
Object.assign(textTranslations, {
  ...
  "SaaS para lavanderias": "Laundry SaaS",
  ...
  "Nexus recomienda este producto para lavanderias que necesitan pickup, delivery, tracking y pagos.": "Nexus recommends this product for laundries that need pickup, delivery, tracking and payments.",
...
Object.assign(englishTextTranslations, {
  "Laundry SaaS": "SaaS para lavanderias",
  ...
  "Nexus recommends this product for laundries that need pickup, delivery, tracking and payments.": "Nexus recomienda este producto para lavanderias que necesitan pickup, delivery, tracking y pagos.",
