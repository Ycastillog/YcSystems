  ...
  return `<footer class="site-footer">
    <div class="container footer-grid">
      <div class="footer-brand">
        ...
        <p>Operational software for modern businesses.</p>
      </div>
...
function privateAcceleratorsSection(prefix) {
  return `<section class="section section-alt"><div class="container">${sectionHead("Productos relacionados", "Capacidades propias aplicadas al problema del cliente", "Cuando una soluci&oacute;n necesita componentes internos, los evaluamos durante el diagn&oacute;stico y los usamos solo si aportan claridad, velocidad o control operativo.")}<div class="value-grid reserved-capability-grid">${reservedCapabilityCards()}</div><div class="section-action"><a class="button secondary" href="${relativeHref("/products/", prefix)}">Ver enfoque de producto</a></div></div></section>`;
}
