...
const assetVersion = "yc-nexus-live-20260714j";
...
renderPage({
  ...
  <section class="section"><div class="container">${sectionHead("Casos", "Experiencias publicadas con evidencia verificable", "Mostramos el alcance y la entrega de trabajos autorizados, sin atribuir cifras ni resultados no documentados.")}<div class="case-grid case-feature-list">${caseCards(prefix, 2)}</div><div class="section-action"><a class="text-link" href="${relativeHref("/case-studies/", prefix)}">Ver todos los casos</a></div></div></section>${finalCta(prefix, "Antes de construir, definamos qu&eacute; necesita m&aacute;s control")}`,
});
