...
const reservedCapabilities = [
  ...
  { label: "04", title: "Ecosistema propio", text: "L&iacute;neas internas protegidas hasta que est&eacute;n listas legal, comercial y operativamente." },
];
...
function homeProductHighlight(prefix) {
  return `<div class="home-product-highlight reserved-product-highlight"><div class="home-product-copy"><p class="kicker">Ecosistema propio</p><h2>Software operativo en construcción responsable</h2><p>YC Systems desarrolla componentes propios para acelerar diagn&oacute;stico, arquitectura y ejecuci&oacute;n. Los detalles internos se publican solo cuando est&aacute;n listos para el mercado.</p><div class="actions"><a class="button primary" href="${relativeHref("/contact/", prefix)}">Solicitar diagn&oacute;stico</a><a class="button secondary" href="${relativeHref("/solutions/", prefix)}">Ver soluciones</a></div></div><div class="reserved-system-card" aria-label="Capacidades privadas de producto"><span>Nexus</span><strong>Operating intelligence layer</strong><small>Diagn&oacute;stico &middot; arquitectura &middot; ejecuci&oacute;n</small><div><em>OS</em><em>CRM</em><em>BI</em><em>AI</em></div></div></div>`;
}

function reservedProductsSection(prefix) {
  return `<section class="section"><div class="container">${sectionHead("Ecosistema propio", "Capacidades internas preparadas para operar mejor", "Estamos construyendo l&iacute;neas de software operativo para mercados concretos. La web muestra la direcci&oacute;n comercial; los nombres, interfaces y detalles se publican cuando cada producto est&aacute; listo para salir al mercado.")}<div class="value-grid reserved-capability-grid">${reservedCapabilityCards()}</div><div class="conversion-panel"><p><strong>Si tu empresa necesita algo similar</strong><span>Podemos evaluar tu operaci&oacute;n y definir una primera fase sin revelar informaci&oacute;n sensible de productos internos.</span></p><a class="button primary" href="${relativeHref("/contact/", prefix)}">Solicitar diagn&oacute;stico</a></div></div></section>`;
}

function privateAcceleratorsSection(prefix) {
  return `<section class="section section-alt"><div class="container">${sectionHead("Aceleradores internos", "Capacidades propias aplicadas al problema del cliente", "Cuando una soluci&oacute;n necesita componentes internos, los evaluamos durante el diagn&oacute;stico y los usamos solo si aportan claridad, velocidad o control operativo.")}<div class="value-grid reserved-capability-grid">${reservedCapabilityCards()}</div><div class="section-action"><a class="button secondary" href="${relativeHref("/products/", prefix)}">Ver enfoque de producto</a></div></div></section>`;
}
...
renderPage({
  ...
  description: "YC Systems construye capacidades propias de software operativo con lanzamiento responsable y acceso controlado.",
  body: (prefix) => `<section class="page-hero products-hero"><div class="container interior-hero-grid"><div><p class="kicker">Productos YC Systems</p><h1>Ecosistema propio en construcción responsable</h1><p class="lead">Desarrollamos capacidades internas para acelerar operaciones reales. La web muestra la direcci&oacute;n; los detalles se publican cuando cada l&iacute;nea est&aacute; lista para el mercado.</p><div class="actions"><a class="button primary" href="${relativeHref("/contact/", prefix)}">Solicitar diagn&oacute;stico</a><a class="button secondary" href="${relativeHref("/solutions/", prefix)}">Ver soluciones</a></div></div><div class="hero-status-guide" aria-label="Principios de exposici&oacute;n"><span><b>Direcci&oacute;n clara</b> Software operativo para negocios reales</span><span><b>Acceso controlado</b> Validaci&oacute;n bajo diagn&oacute;stico</span><span><b>Lanzamiento responsable</b> Publicaci&oacute;n cuando est&eacute; listo</span><span><b>Nexus</b> Capa com&uacute;n de claridad operativa</span></div></div></section>${reservedProductsSection(prefix)}${finalCta(prefix)}`,
});
