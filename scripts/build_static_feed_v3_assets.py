...
def static_case(filename, eyebrow, title, subtitle, shot, tag_items):
    ...
    wrap(d, title, (56, 200), 850, F["title2"], COL["white"], 8, 2)
    wrap(d, subtitle, (58, 345), 790, F["subtitle"], COL["muted"], 8, 2)
...
def static_product(filename, eyebrow, title, subtitle, shot, tag_items):
    ...
    logo(im)
    d.text((56, 145), eyebrow.upper(), font=F["eyebrow"], fill=COL["cyan"])
    wrap(d, title, (56, 200), 800, F["title2"], COL["white"], 8, 2)
    wrap(d, subtitle, (58, 345), 740, F["subtitle"], COL["muted"], 8, 2)
